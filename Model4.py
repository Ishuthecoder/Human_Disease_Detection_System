...
sets = ['Val', 'Test', 'Train']
# Define base pat
base_path = r"C:\Users\dubey\Multi_Cancer_Split"
destination_path = r"C:\Users\dubey\Multi_Cancer_Split\Destiny_path"

# Automatically fetch the 26 group names
groups = os.listdir(os.path.join(base_path, 'Train'))
    ...
    for group in groups:
        ...
        for dos in os.listdir(ima_dir):
            ...
            if dos == 'images':
                ...
                group_counts[group] += num

# Summary print
print("\n--- Summary of Image Counts Across Groups ---")
...
def build_model():
    ...
    x = Dropout(0.2)(x)
    output = Dense(26, activation='softmax')(x)  # 26 classes now
...
# Save the model
Model_DNet.save("Covid_Model_Segmentation.keras" , save_format="keras")
